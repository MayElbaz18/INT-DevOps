...
def check_certificate(url):
    result = {"expiration_status": '', "expiration_date": ''}
    try:
        ...
        result["expiration_status"] = 'failed'
        result["expiration_date"] = str(e)
...
print(f"URL liveness and cert checks complete in {elapsed_time:.2f} seconds.")